...
// Design Name: 
// Module Name: ex_brightness_increase
// Project Name: 
// Target Devices: 
// Tool Versions: 
...
module ex_brightness_increase #(
    parameter string file_name     = "../../../../../butterfly.bmp",
    parameter string out_file_name = "../../../../../butterfly_brightness_increase.bmp",
    ...
    brightness u_brightness (
        ...
        .rst(rst),
        .in_ready(rgb_valid),
        .brightness_factor(8'd50), // Example brightness factor
        .in_red(in_red),
        .in_green(in_green),
        .in_blue(in_blue),
        .out_red(out_red),
